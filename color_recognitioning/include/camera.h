...
public:
    ...
    Eigen::Vector3d world2camera(const Eigen::Vector3d &point_in_world, const Sophus::SE3d &Twc);
    Eigen::Vector3d camera2world(const Eigen::Vector3d &point_in_camera, const Sophus::SE3d &Twc);
    ...
    Eigen::Vector3d pixel2world(const Eigen::Vector2d &point_in_pixel, const Sophus::SE3d &Twc, double depth);
    cv::Mat mK; //内参矩阵
